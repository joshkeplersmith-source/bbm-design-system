...
1. What color is the zone the logo sits in?
   ...
   - Light background, brand-forward → **Bu variant** (blue P-700)
...
**Default surface:** N-100 with texture is the default for all standalone deliverables — posters, emails, landing pages, social, documents. P-700 is for intentional contrast within a layout, never the default starting point. When in doubt, build light.
